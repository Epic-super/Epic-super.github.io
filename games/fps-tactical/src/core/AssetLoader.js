...
export class AssetLoader {
  ...
  async loadTextures() {
    const base = import.meta.env.BASE_URL;
    const textures = [
      { name: 'ground_diffuse', path: `${base}textures/ground/concrete_diffuse.jpg` },
      { name: 'ground_normal', path: `${base}textures/ground/concrete_normal.jpg` },
      { name: 'ground_roughness', path: `${base}textures/ground/concrete_roughness.jpg` },
      { name: 'wall_diffuse', path: `${base}textures/walls/brick_diffuse.jpg` }
    ];
