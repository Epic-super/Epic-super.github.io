...
function renderTools(){
  ...
  var sysTools = [
      ...
      {name:'实时航班雷达', link:'lab/products/flight-radar.html', note:'北京/上海上空实时航班 · 呼号·来源国·高度·速度·航向 · 繁忙度对比', self:true},
      ...
      {name:'世坤量化学习台', link:'worldquant-learn.html', note:'量化学习笔记(原创·与官方无关联) · 概念库 / 学习路径 / BRAIN Learn 分栏', self:true, local:true}
