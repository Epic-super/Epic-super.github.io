...
export function initNavigation(){
  ...
  window.addEventListener("message", function(e){
    ...
    if(d && d.__wbResize && d.id === "indiePortfolioFrame"){ var ip = document.getElementById("indiePortfolioFrame"); if(ip) ip.style.height = (d.h + 24) + "px"; }
    if(d && d.__wbResize && d.id === "starship3dFrame"){ var st = document.getElementById("starship3dFrame"); if(st) st.style.height = (d.h + 24) + "px"; }
    if(d && d.__wbResize && d.id === "techdebtFrame"){ var tdf = document.getElementById("techdebtFrame"); if(tdf) tdf.style.height = (d.h + 24) + "px"; }
  });
